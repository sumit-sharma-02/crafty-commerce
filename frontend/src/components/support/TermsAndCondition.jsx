...
const TermsAndCondition = () => {
  return (
    <main className="mb-20 sm:mb-40">
      {/* <!--------------Breadcrumb-----------------------> */}
      <div class="flex items-center px-4 pt-6 text-sm font-medium uppercase text-gray-500 sm:px-10 xl:px-24">
        {/* <!--------------> */}
        <Link class="flex items-center hover:text-yellow-500" to={"/"}>
          <span>
            <svg
        ...
        {/* <!--------------> */}
        <Link class="cursor-pointe text-gray-400">Terms & Conditions</Link>
      </div>
      {/* <!--------------Breadcrumb End-----------> */}
      {/* <!-- == Terms and Condition == --> */}
      <section class="px-4 pt-5 sm:px-10 xl:px-24">
        {/* <!------001-------> */}
        <div class=" text-gray-500">
          <p>
            <h4 class=" mt-5 text-2xl font-bold tracking-tight text-black">
              AGREEMENT TO TERMS
            </h4>
            <br />
            ...
            <ul class="my-4 ml-6 list-disc">
              ...
              <li>
                17. harass, annoy, intimidate, or threaten any of our employees
                or agents engaged in providing any portion of the Site to you.
              </li>
              <li>
                18. delete the copyright or other proprietary rights notice from
                any Content.
              </li>
              <li>
              ...
              <li>
                24. use the Site in a manner inconsistent with any applicable
                laws or regulations.
              </li>
            </ul>
            <br />
